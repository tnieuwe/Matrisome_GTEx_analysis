...
load("input/median_gtex_v8.rda")

#Select v8 or v7
#median_tpm <- read.csv("median_tpm_v7.csv", stringsAsFactors = F)
median_tpm <- read.csv("input/median_tpm_v8.csv", stringsAsFactors = F)


## Read in matrisome data
matrisome_tab <- read.csv("input/matrisome_hs_masterlist_EDIT_r.csv", stringsAsFactors = F)
...
pheatmap(core_cor,
                ...
                filename="output/core_matrisome_correlation_v8.pdf",
                width=7, height=7)
...
ggsave(filename = "output/percent_transcriptome_matrisome_v8.pdf", width = 10, height = 10)

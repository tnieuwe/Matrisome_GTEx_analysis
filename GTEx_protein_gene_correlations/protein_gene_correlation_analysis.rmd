...
## Source https://www.sciencedirect.com/science/article/pii/S0092867420310783#mmc3
protein_raw <- readxl::read_xlsx("data_in/1-s2.0-S0092867420310783-mmc3.xlsx",sheet = 6,skip = 0)
## Source https://www.sciencedirect.com/science/article/pii/S0092867420310783#mmc4
...
## SOurce https://www.sciencedirect.com/science/article/pii/S0092867420310783#mmc5
...
## Get min and max pairs that aren't 1
melt_cor_master <- reshape2::melt(cor_master) %>% filter(value != 1)
melt_cor_master %>% arrange(desc(value))
## Now matrisome
...
melt_cor_master_matrisoem <- reshape2::melt(cor_master_matrisome) %>% filter(value != 1)
melt_cor_master_matrisoem %>% arrange(desc(value))



cor_bind_master <- rbind(cor_master, cor_master_matrisome)


pheatmap(cor_bind_master,cluster_rows = F, cluster_cols = F,
         filename = "data_out/doubled_heatmap_for_scale.pdf", width = 8, height = 12)
```

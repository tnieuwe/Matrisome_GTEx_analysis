...
for (tcga_ind in seq_along(rse_list)) {
    ...
    result_list[[names(rse_list)[tcga_ind]]] <- plot_list
    ...
    row_high <- cbind(high_higher_curve, high_pval, high_sig, "rank up genes", names(rse_list)[tcga_ind])
    ...
    row_low <- cbind(low_higher_curve, low_pval, low_sig, "rank down genes", names(rse_list)[tcga_ind])
    ...
    new_rows_aov$tcga_cancer <- names(rse_list)[tcga_ind]
